    ...
    <section className="h-screen w-full relative mx-auto flex justify-center items-center">
      <div className="p-10 flex">
        ...
        <div className="pt-10 pr-10 pl-10 rounded-2xl w-1/2 bg-accent">
          {registerState ? (
            <h1 className="font-bold text-[34px] text-white text-center">
              Registration
            </h1>
          ) : (
            <h1 className="font-bold text-[34px] text-white text-center">
          ...
          {registerState ? (
            <p className="text-center text-white mt-1">Create your account</p>
          ) : (
            <p className="text-center text-white mt-1">Login to your account</p>
          )}
          <form className="flex flex-col mt-1" ref={formRef}>
                ...
                <>
                  <div className="flex flex-row items-center">
                    <label className="cursor-pointer label">
                      <input
                        type="checkbox"
                        className="checkbox checkbox-success bg-white border border-accent w-4 h-4 rounded hover:border-accent"
                      />
                    </label>
                    <span className="label-text ml-[2px] text-[16px]">
                      Remember me
                    </span>
                  </div>
            ...
            <div className="flex flex-col items-center">
              <button
                className="w-full py-3 border-black bg-secondary rounded-full text-white font-bold text-[18px] hover:underline mt-5"
                onClick={onSubmithandler}
              >
                {registerState ? <>Sign Up</> : <>Login</>}
              </button>
