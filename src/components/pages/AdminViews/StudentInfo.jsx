                    ...
                    {documentList.map((documents, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-end">
                                <button className="btn bg-secondary text-white text-[20px] hover:bg-secondary border border-secondary hover:border-secondary mx-2 w-[60px] tooltip tooltip-bottom" data-tip="Upload">
